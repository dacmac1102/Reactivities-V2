...
export default function ProfileContent() {
    ...
    const tabContent = [
        ...
        { label: 'Followers', content: <ProfileFollowings activeTab={value}></ProfileFollowings> },
        { label: 'Following', content: <ProfileFollowings activeTab={value}></ProfileFollowings> },
    ]
